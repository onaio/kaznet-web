...
ONA_COMMENTS_FIELD = '_review_comment'
ONA_LAST_PASSWORD_EDIT_FIELD = 'last_password_edit'
ONA_GEOLOCATION_FIELD = '_geolocation'
SUBMISSION_AUTO_APPROVAL = False
ONA_SUBMISSION_REVIEW_APPROVED = '1'
ONA_SUBMISSION_REVIEW_REJECTED = '2'
