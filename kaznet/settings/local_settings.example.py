...
# tasks
CELERY_ROUTES = {
    "kaznet.apps.ona.tasks.task_fetch_missing_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_fetch_form_missing_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_sync_updated_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_sync_form_updated_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_sync_deleted_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_sync_form_deleted_instances": {"queue": "submissions"},
    "kaznet.apps.ona.tasks.task_fetch_projects": {"queue": "forms"},
}

CELERY_BEAT_SCHEDULE = {
    "sync_missing_submission_reviews": {
        "task": "task_sync_missing_submission_reviews",
        "schedule": crontab(hour="*", minute="*/60"),  # every 60 minutes
    },
